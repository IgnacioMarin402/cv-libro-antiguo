...
// Every lathed object in the scene (today, the candlestick) keeps its
// profile as data in its own feature's domain and gets its mesh from here,
// so no two re-implement the same revolution.
